...
- [`sdk/typescript`](./sdk/typescript) — `cd sdk/typescript && npm install && npm run build` (or `npm install @daimon-protocol/sdk` once published), then `import { Client } from "@daimon-protocol/sdk"`
