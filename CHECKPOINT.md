...
| v0.4 | months 6–9 | Biscuit-token capability delegation, reputation primitive | **Design doc written 2026-05-21** — [`design/v0.4-delegation.md`](./design/v0.4-delegation.md). 8 phases sketched (40–47). Implementation not started. |
